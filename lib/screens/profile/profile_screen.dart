    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _item("Tanggal Lahir", _profile!["TANGGALLAHIR"], false),
          _item(
            "Jenis Kelamin",
          ...
          _editField(
            "ID Asuransi",
            _idasuransiController,
            _editMode,
            keyboard: TextInputType.number,
          ),
          _editField("No Asuransi", _noasuransiController, _editMode),
          _item("Tanggal Daftar", _profile!["TANGGALDAFTAR"], false),
        ],
      ),
    );
  }
